	...
	return (
		...
		>
			<div className='flex items-center justify-between'>
				...
				>
					...
					<h2
						className={
							font.className +
							' tracking-wider text-base  md:text-2xl leading-none'
						}
					>
						YEŞİLBURSA <br className='md:hidden block' /> PASLANMAZ
					</h2>
				</Link>
				<ul className='sm:flex justify-between hidden gap-4'>
					{/* <li className='cursor-pointer' onClick={() => scrollToDiv('#about')}> */}
					<Link href='/catalog?tab=hakkimizda' className='cursor-pointer'>
						Hakkımızda
					</Link>
					{/* </li> */}
					<Link href='/catalog?tab=ostenitik' className='cursor-pointer'>
						Ürünler
					</Link>
					<li
			...
			<ul
				...
				} flex flex-col gap-4 transition-all overflow-hidden sm:hidden items-center bg-customWhite/100 text-customPrimary absolute w-full top-18 left-0 text-md`}
			>
				{/* <li className='cursor-pointer' onClick={() => scrollToDiv('#about')}>
          Hakkımızda
        </li> */}
				<Link
					href='/catalog?tab=hakkimizda'
